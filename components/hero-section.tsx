...
export const HeroSection = forwardRef<HTMLElement>(function HeroSection(_, ref) {
  ...
  return (
    ...
    >
      {/* Hero Text with heading wrapper for seed positioning */}
      <div className="relative z-10 flex items-start justify-center pt-8 md:justify-start md:pl-[16%] lg:pl-[18%] lg:pt-12">
        {/* Heading wrapper - position: relative so seed can anchor to it */}
        <div id="hero-heading-wrapper" className="relative overflow-visible">
